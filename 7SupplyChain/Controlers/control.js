...
const A_manufactureRequest = async (req, res) => {
    ...
    const a1 = await acc.methods.A_manufactureRequest(_partName ,_quantity ,_date ,_price ,_nameOfYourCompany).call({ from: '0x4c93f756D408b792313072349005B136D6A8561C' ,gas: 1000000});
    hash =a1;
    const a = await acc.methods.A_manufactureRequest(_partName ,_quantity ,_date ,_price ,_nameOfYourCompany).send({ from: '0x4c93f756D408b792313072349005B136D6A8561C' ,gas: 1000000});
    res.send(a1);
    console.log(a1);
}
